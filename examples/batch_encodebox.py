...
from wtfop.wtfop_ops import boxes_encode1,boxes_encode
sess = tf.Session()
gboxes = tf.Variable(
...
glen = tf.Variable([4,3,2]);
boxes = tf.Variable(
[[0.0,0.0,0.2,0.1],[0.0,0.0,0.2,0.2],[0.101,0.1,0.44,0.4],[0.73,0.71,0.91,0.81],[0.7,0.1,0.9,0.5],[0.3,0.481,0.5,0.7]]
#[[[0.0,0.0,0.2,0.1],[0.0,0.0,0.2,0.2],[0.101,0.1,0.44,0.4],[0.73,0.71,0.91,0.81],[0.7,0.1,0.9,0.5],[0.3,0.481,0.5,0.7]],
#[[0.0,0.0,0.2,0.1],[0.0,0.0,0.2,0.2],[0.101,0.1,0.44,0.4],[0.73,0.71,0.91,0.81],[0.7,0.1,0.9,0.5],[0.3,0.481,0.5,0.7]],
#[[0.0,0.0,0.2,0.1],[0.0,0.0,0.2,0.2],[0.101,0.1,0.44,0.4],[0.73,0.71,0.91,0.81],[0.7,0.1,0.9,0.5],[0.3,0.481,0.5,0.7]]]
);
out_boxes,out_labels,out_scores,out_remove_indices = boxes_encode(boxes,gboxes,glabels,glen,0.8,0.3)
...
out_scoures [[0.         1.         0.87941164 0.67400867 0.         0.29750007]
 [0.         1.         0.87941164 0.         0.         0.29750007]
 [0.         1.         0.         0.         0.         0.29750007]]
