...
class WTFOPTest(tf.test.TestCase):
    ...
    def apply_deltas(self,regression,img_size=None,fm_size=None):
        ...
        base_value = tf.Print(base_value,["y_base",y_base_value],summarize=1000)
        base_value = tf.Print(base_value,["x_base",x_base_value],summarize=1000)
        base_value = tf.Print(base_value,["XXXX",base_value],summarize=1000)
